                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="my-3">
                                <input type="text" id="due_date" name="due_date" value="{{ old('due_date') }}" class="due_date bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Due Date">
                                @error('due_date')
                                    <p class="text-red"> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <label for="assigned_user" class="text-lg font-medium">
                                Assign To
                            </label>
                            <div class="my-3">
